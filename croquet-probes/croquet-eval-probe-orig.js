...
const URL = 'http://localhost:8080/croquetpsoup-test.html?snapshot=CroquetHopscotchWebIDE-TEST.vfuel&sessionId=' + SESSION + '&pwd=test&appId=org.newspeaklanguage.evprobe&apiKey=none&reflector=ws://localhost:9090&files=/files';
const STEPS = [
  ["w1", "platform js global at: 'w1' put: 'basic'"],
  ["m1", "platform js global at: 'm1' put: ([:mb | mb nestedClasses addFromSource: 'public class ZY1 contents: c <String> = Document named: #ZY1 contents: c ()()'. platform js global at: 'mid' put: 'ADD-COMPLETED'. 'DONE'] value: ide documents documentHolderMixinBuilder)"],
];
