...
dedupllicateMixins = (
  | mixinMap = Map new. |
   mixinsDeduplicated ifFalse: [
	mixins do: [:m <ClassDeclarationIR> |
		mixinMap at: m qualifiedName put: m.
		].
